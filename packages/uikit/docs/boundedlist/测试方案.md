...
> 入口关系：专题入口见 [`README.md`](README.md)，接口口径见 [`组件设计.md`](组件设计.md)，浏览器缺陷证据见 [`缺陷列表.md`](缺陷列表.md)，仓库整体测试分层见 [`../../../../docs/development/测试方案.md`](../../../../docs/development/测试方案.md)。
...
缺陷编号、成因、修复和回归证据统一维护在 [`缺陷列表.md`](缺陷列表.md)，本测试方案不再复制第二份缺陷表：

- `BL-BUG-001`～`BL-BUG-012`：真实 Chromium 专项发现的产品缺陷。
