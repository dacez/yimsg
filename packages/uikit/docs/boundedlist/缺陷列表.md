...
> 主要对照：`packages/uikit/src/app/bounded-list/`、`apps/web/tests/ui/bounded-list/bounded-list.spec.ts` 与 `bounded-list.performance.spec.ts`。
> 最后复核：2026-07-29。
...
3. 运行 51 项功能专项、6 项性能专项以及仓库全量测试；全量脚本以 `--project=chromium --retries=0` 包含功能专项但不重复运行性能专项。
