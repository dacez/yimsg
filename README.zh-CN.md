...
Yimsg SDK 所有长期驻留集合均为**有界集合**：容量在构造时确定、运行期不再增长，禁止无界 Map / Set / Queue 长期增长，因此 SDK 峰值内存静态可估算。详见 [`docs/frontend/sdk/有界集合方案.md`](docs/frontend/sdk/有界集合方案.md)。
...
`YimsgClient.estimateMaxMemoryBytes(options)` 把所有有界集合（缓存、队列、待响应请求、同步批次、基线）纳入理论峰值估算，纯静态、无副作用，可在构造实例前调用。各分项均静态可计算，详见 [`docs/frontend/sdk/sdk设计方案.md`](docs/frontend/sdk/sdk设计方案.md) §11。
...
- 接口总览：[`docs/protocol/接口总览.md`](docs/protocol/接口总览.md)
...
- SDK 设计与接口：[`docs/frontend/sdk/sdk设计方案.md`](docs/frontend/sdk/sdk设计方案.md)、[`docs/frontend/sdk/sdk接口说明.md`](docs/frontend/sdk/sdk接口说明.md)
- UIKit 方案：[`docs/frontend/uikit/UIKit方案.md`](docs/frontend/uikit/UIKit方案.md)
- 测试方案：[`docs/测试方案.md`](docs/测试方案.md)
- 插件架构：[`docs/server/插件架构方案.md`](docs/server/插件架构方案.md)
