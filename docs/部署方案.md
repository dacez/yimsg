...
> 主要对照：`tools/scripts/build.sh`、`tools/scripts/install-windows-autostart.ps1`、`tools/scripts/deploy-windows-local.ps1`、`cmd/server/main.go`、`internal/config/config.go`、`config.toml`。
> 最后复核：2026-07-11。
