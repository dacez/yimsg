...
| 系统 | 架构 | 文件 |
|---|---|---|
| Windows | x86-64（Go `amd64`） | `yimsg-0.1.3-windows-x86_64.zip` |
| Linux | x86-64（Go `amd64`） | `yimsg-0.1.3-linux-x86_64.tar.gz` |
| Linux | ARM64 | `yimsg-0.1.3-linux-arm64.tar.gz` |
| macOS | Apple Silicon / ARM64 | `yimsg-0.1.3-macos-arm64.tar.gz` |
