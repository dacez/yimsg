...
> 主要对照：`tools/scripts/`、`tools/release/`、`tools/cmd/protocolgen/`、`tools/cmd/check-docs-consistency/`、根目录 `AGENTS.md`。
> 最后复核：2026-07-19。
...
| 路径 | 职责 |
|---|---|
| `scripts/` | shell 脚本真实实现，包含全量测试、文档校验、覆盖率、质量门禁、发行包构建和服务器环境初始化 |
