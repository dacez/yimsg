...
import { login, getContacts, sendMessage } from '../../../src/sdk/generated/actions.gen';
import type { ClientTransport } from '../../../src/sdk/transport/connection';
import {
  GetContactsResponse,
  LoginRequest,
  LoginResponse,
